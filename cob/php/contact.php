...
<div id="layout">
    ...
    <div id="main">
        ...
        You can reach us in:
        <br>
        <a href="mailto:kmaninis@vision.ee.ethz.ch;jponttuset@vision.ee.ethz.ch"><span class="square"><i class="fa fa-envelope"></i></span></a>
        <a href="https://twitter.com/intent/tweet?text=%40kmaninis%20%40jponttuset%20"><span class="square"><i class="fa fa-twitter"></i></span></a>
        ...
        Or use the contact form below:
            ...
            <input type="hidden" name="recipients" value="kevismaninis@gmail.com" />
            <input type="hidden" name="required" value="EmailAddr:Your email address" />
            <input type="hidden" name="subject" value="COB web Feedback" />
