    ...
    <div id="main">
        ...
        <div style="margin: auto;max-width: 1200px;">
            <div style="font-family: 'Raleway', sans-serif;margin-left:15px;margin-right:10px;margin-bottom:15mm;">
                ...
                <i>Dashed lines refer to methods which do not provide segmentations, but contour maps. For comparison on BSDS500, visit the <a href="https://cvlsegmentation.github.io/seism/soa_compare.php" target="_blank">SEISM website</a>.</i>
