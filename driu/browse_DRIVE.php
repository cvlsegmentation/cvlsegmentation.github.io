    ...
    <div id="main">
        ...
        <div class="pure-g">
            <div class="pure-u-1-4" style="text-align:center;font-family: 'Raleway', sans-serif;">
                <button class="btn btn-6 btn-6a" style="color: #6b7770;background: #e7eae8;width: 95%;margin-top:30px;">DRIVE</button>
            </div>
            <div class="pure-u-1-4" style="text-align:center;font-family: 'Raleway', sans-serif;">  
        ...
        <div class="pure-g">
            <div class="pure-u-1-1" style="font-family: 'Raleway', sans-serif; margin-top: 30px;margin-left: 0%;margin-right: 0%;">
              <center>List of images from DRIVE test set. Please click on any thumbnail to see all detections on that image.</center>
            </div>
        </div>
        ...
        <script type="text/javascript">
            im_horiz =  ["01_test","02_test","03_test","04_test","05_test","06_test","07_test","08_test","09_test","10_test","11_test","12_test","13_test","14_test","15_test","16_test","17_test","18_test","19_test","20_test"];
            ...
            function show_images(div_id,class_id,im_list)
            {
                ...
                '<div class="'+class_id+'"><div class="boxInner"><a href="one_result.php?database=DRIVE&im_id='+im_list[i]+'"><img src="img/thumbnails/DRIVE/'+ im_list[i] +'_thumb.png"/></a><div class="titleBox">'+im_list[i]+'</div></div>'
            }
