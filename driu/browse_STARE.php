...
<div id="layout">
    ...
    <div id="main">
        ...
        <div class="pure-g">
            ...
            <div class="pure-u-1-4" style="text-align:center;font-family: 'Raleway', sans-serif;">  
                <button class="btn btn-6 btn-6a" style="color: #6b7770;background: #e7eae8;width: 95%;margin-top:30px;">STARE</button>
            </div>
            <div class="pure-u-1-4" style="text-align:center;font-family: 'Raleway', sans-serif;">  
        ...
        <div class="pure-g">
            <div class="pure-u-1-1" style="font-family: 'Raleway', sans-serif; margin-top: 30px;margin-left: 0%;margin-right: 0%;">
              <center>List of images from STARE test set. Please click on any thumbnail to see all detections on that image.</center>
            </div>
        </div>
        ...
        <script type="text/javascript">
            im_horiz =  ["im0162","im0163","im0235","im0236","im0239","im0240","im0255","im0291","im0319","im0324"];
            ...
            function show_images(div_id,class_id,im_list)
            {
                ...
                '<div class="'+class_id+'"><div class="boxInner"><a href="one_result.php?database=STARE&im_id='+im_list[i]+'"><img src="img/thumbnails/STARE/'+ im_list[i] +'_thumb.png"/></a><div class="titleBox">'+im_list[i]+'</div></div>'
            }
